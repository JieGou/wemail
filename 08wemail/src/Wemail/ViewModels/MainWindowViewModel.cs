...
namespace Wemail.ViewModels
{
    public class MainWindowViewModel : BindableBase
    {
        ...
        public CompositeCommand TempCompoCommand
        {
            get => _tempCompoCommand ?? (_tempCompoCommand = new CompositeCommand());
        }
        ...
        {
            get => _prameterCommand ?? (_prameterCommand = new DelegateCommand<string>(PrameterAction));
        }
        ...
        private void PrameterAction(string prameter)
        {
            ...
            var eventModel = new TempEventModel
            {
                Age = 18,
                Name = prameter,
                MessageType = MessagerType.JusterMessage,
            };
